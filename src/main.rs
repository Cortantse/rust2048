...
use tui::{
    backend::{Backend, CrosstermBackend}, layout::{Alignment, Constraint, Direction as Dire, Layout, Rect}, style::{Color, Modifier, Style}, terminal, text::{Span, Spans, Text}, widgets::{Block, Borders, Paragraph}, Frame, Terminal
};
use std::{borrow::BorrowMut, io::{self, Stdout}};
use rand::Rng;
use game::{Grid, Move};
